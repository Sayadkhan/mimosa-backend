...
userSchema.statics.register = async function (name, email, password, photoUrl, address, phoneNumber) {
    ...
    if (!validator_1.default.isStrongPassword(password)) {
        throw new Error('password must be 8 careater , conains uppercase , lowercase number and special creacter');
    }
    const salt = await bcrypt_1.default.genSalt(10);
    const hasPassword = await bcrypt_1.default.hash(password, salt);
